    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="dashboard.php">Bengkel Ardans</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="data_transaksi.php">Transaksi</a></li>
                    <li class="nav-item ms-3"><a class="btn btn-danger btn-sm mt-1" href="logout.php" onclick="return confirm('Yakin ingin keluar?');">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
